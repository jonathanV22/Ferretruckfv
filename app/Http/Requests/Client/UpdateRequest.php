...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'rut'=>'nullable|string|unique:clients,ruc,'.$this->route('client')->id.'|min:11|max:11',
    ...
    public function messages()
    {
        return[
            ...
            'rut.unique'=>'El número de RUC ya se encuentra registrado.',
            'rut.min'=>'Se requiere de 11 caracteres.',
            'rut.max'=>'Solo se permite 11 caracteres.',
